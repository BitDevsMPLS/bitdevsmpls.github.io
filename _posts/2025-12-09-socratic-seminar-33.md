...
Welcome! We are back at the Big Brothers Big Sisters building in Minneapolis this month while Improving Inc is moving. See below for address.

This meetup will be run in the format of a Socratic Seminar, inspired by other [BitDevs Socratic Seminars across the country](https://bitdevs.org/cities).

# Details
 - Where: [3110 N Washington Ave, Minneapolis](https://maps.app.goo.gl/s5R5cUr7E2kRxdSR8)
 - When: Tuesday December 9th. Socratic Seminar from 6pm - 8pm.
 - [La Doña Cervecería Brewery](241 Fremont Ave N, Minneapolis, MN 55405) for happy hour
